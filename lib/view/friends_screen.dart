...
class _FriendsScreen extends State<FriendsScreen> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              // Header - menarik dengan gradient
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xFF3A206C).withOpacity(0.3),
                      blurRadius: 15,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildAttractiveLeaderBoard(user),
                        const SizedBox(height: 15),
                      ],
                    ),
                  ),
              ...
              // Content - menarik dengan design modern
              Container(
  ...
  Widget _buildAttractiveLeaderBoard(List<Student> list) {
        ...
        Container(
          ...
          Container(
            child: Row(
              ...
              children: [
                _buildAttractivePodiumItem(list, 1, 'lib/assets/leaderboards/banner-silver.png', const Color(0xFF6B7280)),
                _buildAttractivePodiumItem(list, 0, 'lib/assets/leaderboards/banner-gold.png', const Color(0xFFF59E0B)),
                _buildAttractivePodiumItem(list, 2, 'lib/assets/leaderboards/banner-bronze.png', const Color(0xFFEF4444)),
              ],
            ),
          ),
      ],
  ...
  Widget _buildAttractiveFriendCard(Student student, int index) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            // Rank Badge dengan asset juara 1,2,3
            Container(
              width: 50,
              height: 50,
              decoration: BoxDecoration(
